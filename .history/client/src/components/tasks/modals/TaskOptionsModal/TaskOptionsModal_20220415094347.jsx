...
export const TaskOptionsModal = ({ taskId, noTasks, invalidFilter }) => {
	const { setTasks, setTasksCopy, setEditTaskId } = useContext(TasksContext);
	const { openEditTaskModal, openCreateTaskModal } =
