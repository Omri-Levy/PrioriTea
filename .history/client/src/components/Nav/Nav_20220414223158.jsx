...
import slideNav from '../../static/js/slide-nav/slide-nav.js';
...
export const Nav = () => {
	...
	useEffect(() => {
		...
		const fetchCurrentUser = async () => {
			...
			const currentPageIsSignin = window.location.pathname === '/sign_in';
	...
	return (
		<nav>
			<ul>
				...
				{!isSignedIn && (
					<li className="nav-link">
						<NavLink activeClassName="current-link" to="/sign_in">
							SIGN IN
						</NavLink>
					</li>
				)}
				...
				{!isSignedIn && (
					<li className="nav-link">
						<NavLink activeClassName="current-link" to="/sign_up">
							SIGN UP
						</NavLink>
					</li>
				)}
