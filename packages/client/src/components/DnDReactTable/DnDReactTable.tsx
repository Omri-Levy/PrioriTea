 ...
 */
export const DnDReactTable = <TData extends Array<Column<{}>>,
	TColumns extends Array<Column>>(
	props: DnDReactTableProps<TData, TColumns>
) => {
	const {
		data,
		columns,
	...
	const tableData = useMemo(
		() => (isLoading ? arrayOfN(skeletonRows) : data),
		[isLoading, data]
	);
	...
	useSetSearchParams(filters, globalFilter, sortBy, pagination);
