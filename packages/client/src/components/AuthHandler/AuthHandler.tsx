...
import { useUserInfoQuery } from "../pages/SignIn/hooks/useUserInfoQuery/useUserInfoQuery";
import { Section } from "../Section/Section";
import { useIncrementOnInterval } from "../../hooks/useIncrementOnInterval/useIncrementOnInterval";
 ...
 * @constructor
 */
export const AuthHandler: FunctionComponent<{ children: any }> = ({
	children,
}) => {
	...
	if (isLoading) {
		return <Progress className="progress-bar" size="xl" value={percent} />;
	}
